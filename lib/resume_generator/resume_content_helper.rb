module ResumeGenerator
  module ResumeContentHelper
    ...
    def rc
      ...
      position_header(
        position: {
          title: 'U2VuaW9yIERldmVsb3Blcg=='
        },
        organisation: {
          name: 'UmF0ZUNpdHkuY29tLmF1'
        },
    ...
    def gw
      ...
      position_header(
        position: {
          title: 'UHJlLXNhbGVzIENvbnN1bHRhbnQ='
        },
        organisation: {
          name: 'R3VpZGV3aXJlIFNvZnR3YXJl'
        },
    ...
    def rnt
      ...
      position_header(
        position: {
          title: "SW1wbGVtZW50YXRpb24gQ29uc3VsdGFudCwgUHJvZmVzc2lvbmFsIFNlcn"\
                   "ZpY2Vz"
        },
        organisation: {
          name: 'UmlnaHQgTm93IFRlY2hub2xvZ2llcw=='
        },
    ...
    def sra
      ...
      position_header(
        position: {
          title: 'U29mdHdhcmUgRW5naW5lZXI='
        },
        organisation: {
          name: 'U29mdHdhcmUgUmVzZWFyY2ggQXNzb2NpYXRlcyAoU1JBKQ=='
        },
    ...
    def jet
      ...
      position_header(
        position: {
          title: 'Q29vcmRpbmF0b3Igb2YgSW50ZXJuYXRpb25hbCBSZWxhdGlvbnMgKENJUik='
        },
        organisation: {
          name: "SmFwYW4gRXhjaGFuZ2UgYW5kIFRlYWNoaW5nIFByb2dyYW1tZSAoSkVU"\
                  "KQ=="
        },
    ...
    def satc
      ...
      position_header(
        position: {
          title: "SW50ZXJuYXRpb25hbCBNYXJrZXRpbmcgQXNzaXN0YW50IOKAkyBBc2lhIGFu"\
                   "ZCBKYXBhbg=="
        },
        organisation: {
          name: 'U291dGggQXVzdHJhbGlhbiBUb3VyaXNtIENvbW1pc3Npb24='
        },
    ...
    def mit
      ...
      position_header(
        position: {
          title: 'TWFzdGVycyBvZiBJbmZvcm1hdGlvbiBUZWNobm9sb2d5'
        },
        organisation: {
          name: 'VW5pdmVyc2l0eSBvZiBTb3V0aCBBdXN0cmFsaWE='
        },
    ...
    def ryu
      ...
      position_header(
        position: {
          title: 'U3R1ZGVudCBFeGNoYW5nZSBQcm9ncmFtbWU='
        },
        organisation: {
          name: 'Unl1a29rdSBVbml2ZXJzaXR5'
        },
    ...
    def tafe
      ...
      position_header(
        position: {
          title: 'Q2VydGlmaWNhdGUgSUkgaW4gVG91cmlzbQ==',
          at: 280
        },
        organisation: {
          name: 'QWRlbGFpZGUgVEFGRQ==',
          at: 280
        },

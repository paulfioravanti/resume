...
module Resume
  ...
  module Output
    ...
    #   @param key [Symbol] The message key to translate
    #   @param options [Hash] The options to pass in to the translation message
    # @return [nil]
    def error(...)
      puts Colours.red(I18n.translate(...))
    end
    ...
    # @return [nil]
    def warning(...)
      puts Colours.yellow(I18n.translate(...))
    end
    ...
    # @return [nil]
    def success(...)
      puts Colours.green(I18n.translate(...))
    end
    ...
    # @return [nil]
    def info(...)
      puts Colours.cyan(I18n.translate(...))
    end

...
- Prawn 1.0.0 (if you don't have the Prawn version 1.0.0 gem installed, you will be asked for permission to install it)
- RSpec 2.14.1, if you want to run the specs
